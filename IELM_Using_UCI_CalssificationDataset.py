...
def train_regression_data(train_data, train_labels):
    ...
    plt.title("Learning Curve For Classification dataset")
...
if __name__ == "__main__":
    print("Reading the Classification Dataset file")
    data_uci = np.genfromtxt('wifi_localization.txt', delimiter="")
    #using wifi localization data set from UCI website used in first assignment
